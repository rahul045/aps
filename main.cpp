...
void shortestPath(int source, int destination)
{
    ...
    std::cout << std::endl;
    std::cout << std::endl
              << "Direct distance from source to destination: " << distance[source][destination] << " kms" << std::endl;
...
void minimumCost(int source, int destination)
{
    ...
    std::cout << std::endl;
    std::cout << std::endl
              << "Direct flight cost from source to destination: Rs " << price[source][destination] << std::endl;
...
int main()
{
    ...
    while (true)
    {
        ...
        case 2:
        {
            ...
            std::cout << std::endl
                      << "Source: " << airports[source].second << " ( " << airports[source].first << " )" << std::endl;
